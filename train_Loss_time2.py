...
def train(train_loader, net, criterion, optimizer, epoch, device, train_loss_last):
    global writer
    ...
    for batch_index, (inputs, targets) in enumerate(train_loader):
        ...
        # optimizer.step()
        # print('epoch', epoch)
        optimizer.step(train_loss_last, epoch)
...
def main():
    ...
    for epoch in range(last_epoch + 1, config.epochs):
        ...
        train_loss, train_acc = train(train_loader, net, criterion, optimizer, epoch, device, train_loss_last)
        train_loss_last = train_loss
        if epoch == 0 or (
